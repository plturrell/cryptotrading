...
from ..infrastructure.monitoring.error_tracker import ErrorCategory, ErrorSeverity
    ...
    async def predict_market_movements(
        ...
        with trace_context("grok4_market_prediction") as span:
            try:
                ...
                span.set_attribute("success", "true")
                span.set_attribute(
                    "predictions_count", len(predictions) if isinstance(predictions, dict) else 0
                )
