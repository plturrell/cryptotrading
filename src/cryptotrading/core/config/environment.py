    ...
    def get_environment_info() -> Dict[str, Any]:
        ...
        return {
            ...
            "platform": {
                ...
                "docker": EnvironmentDetector.get_deployment_environment() == DeploymentEnvironment.DOCKER,
                "kubernetes": EnvironmentDetector.get_deployment_environment() == DeploymentEnvironment.KUBERNETES,
            },
            "env_vars": {
...
class FeatureFlags:
    ...
    def use_full_monitoring(self) -> bool:
        ...
        return (
            not self.detector.is_serverless() and
            bool(os.environ.get('OTEL_EXPORTER_OTLP_ENDPOINT')) and
            os.environ.get('DISABLE_MONITORING', '').lower() != 'true'
        )
    ...
    def use_real_apis(self) -> bool:
        ...
        return (
            self.detector.is_production() or
    ...
    def enable_debug_endpoints(self) -> bool:
        ...
        return (
            self.detector.is_development() or
            os.environ.get('ENABLE_DEBUG_ENDPOINTS', '').lower() == 'true'
        )
