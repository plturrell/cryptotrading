...
class DatabaseConfigManager:
    ...
    async def set_config(self, key: str, value: Any, 
        ...
        try:
            ...
            with self.db.get_connection() as conn:
                ...
                """, (
                    key, serialized, env, version,
                    is_encrypted, json.dumps(metadata) if metadata else None
                ))
    ...
    async def get_config_history(self, key: str, 
                               environment: Optional[str] = None,
    ...
    async def import_configs(self, config_data: Dict[str, Any], 
