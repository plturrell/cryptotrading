...
class MLModelRegistry:
    ...
    async def get_model(self, model_id: str, version: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    async def load_model(self, model_id: str, version: Optional[str] = None) -> Optional[Any]:
        ...
        # Download model
        model_data = await self.storage.download_model(
            model_id, 
            model_info['version']
        )
