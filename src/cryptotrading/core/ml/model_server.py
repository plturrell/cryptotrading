...
class ModelRegistry:
    ...
    def __init__(self):
        ...
        self.monitor.log_info(
            ...
            {"storage_type": type(self.storage).__name__, "cache_dir": str(self.local_cache_dir)},
        )

    async def register_model(
        self, model_id: str, model_data: bytes, metadata: Dict[str, Any]
    ) -> ModelVersion:
...
class ModelServingAPI:
    ...
    async def predict(
        self, model_id: str, features: Dict[str, Any], request_id: Optional[str] = None
    ) -> Dict[str, Any]:
...
class ModelPerformanceTracker:
    ...
    async def track_actual_outcome(
        self, model_id: str, prediction_id: str, predicted_value: float, actual_value: float
    ):
