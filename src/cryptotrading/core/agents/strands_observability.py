...
class StrandsObservabilitySystem:
    ...
    async def trace_operation(self, operation_name: str, tags: Dict[str, str] = None):
        ...
        try:
            ...
            await self.record_metric(
                f"operation_duration_{operation_name}", span.duration_ms, MetricType.TIMER, tags
            )
    ...
    async def _check_tool_registry(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"healthy": tool_count > 0, "tool_count": tool_count}
        except Exception as e:
            return {"healthy": False, "error": str(e)}
    ...
    async def _check_workflow_registry(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"healthy": True, "workflow_count": workflow_count}  # Workflows are optional
        except Exception as e:
            return {"healthy": False, "error": str(e)}
