...
class SecureASTValidator:
    ...
    def _setup_allowed_nodes(self):
        ...
        self.forbidden_nodes = {
            ast.Import,
            ast.ImportFrom,  # Prevent imports
...
class CodeSandbox:
    ...
    def __init__(
        self, limits: ExecutionLimits = None, security_level: SecurityLevel = SecurityLevel.STRICT
    ):
    ...
    async def execute_code(
        self, code: str, context: Dict[str, Any] = None, allowed_imports: List[str] = None
    ) -> SandboxResult:
        """
    ...
    def _create_safe_context(
        self, user_context: Dict[str, Any], allowed_imports: List[str]
    ) -> Dict[str, Any]:
    ...
    async def _execute_in_subprocess(self, code: str, context: Dict[str, Any]) -> SandboxResult:
        ...
        try:
            ...
            return SandboxResult(
                result=ExecutionResult.RUNTIME_ERROR, error=f"Subprocess execution failed: {e}"
            )
