    ...
    async def get_memory_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "semantic_memory": {
                ...
                "memory_usage_bytes": sum(len(str(concept)) for concept in self.semantic_memory.values())
            }
        }
...
class ContextManager:
    ...
    async def create_context(self, session_id: str, metadata: Dict[str, Any] = None) -> StrandsContext:
    ...
    async def get_or_create_context(self, session_id: str, 
                                  metadata: Dict[str, Any] = None) -> StrandsContext:
    ...
    async def store_memory(self, session_id: str, key: str, value: Any, 
    ...
    async def add_conversation_entry(self, session_id: str, role: str, 
    ...
    async def add_tool_execution(self, session_id: str, tool_name: str, 
