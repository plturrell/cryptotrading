...
class StrandsAgentDIConfiguration:
    ...
    def configure_core_components(self) -> "StrandsAgentDIConfiguration":
        ...
        self.container.register_singleton(ToolManager, implementation=ToolManager)

        self.container.register_singleton(WorkflowEngine, implementation=WorkflowEngine)

        self.container.register_singleton(ContextManager, implementation=ContextManager)

        # Register secure code executor factory
        self.container.register_singleton(SecureCodeExecutor, factory=lambda: SecureCodeExecutor())
    ...
    def configure_interface_implementations(self) -> "StrandsAgentDIConfiguration":
        ...
        try:
            ...
            self.container.register_singleton(
                ISecurityManager, implementation=DefaultSecurityManager
            )
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(
                ICommunicationManager, implementation=DefaultCommunicationManager
            )
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(ILogger, implementation=StructuredLogger)
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(
                IMetricsCollector, implementation=DefaultMetricsCollector
            )
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(IHealthChecker, implementation=DefaultHealthChecker)
        except ImportError:
    ...
    def configure_external_services(self) -> "StrandsAgentDIConfiguration":
        ...
        try:
            ...
            self.container.register_singleton(UnifiedDatabase, factory=lambda: UnifiedDatabase())
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(MarketDataService, implementation=MarketDataService)
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(DEXService, implementation=DEXService)
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(Web3Service, implementation=Web3Service)
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(APIRateMonitor, implementation=APIRateMonitor)
        except ImportError:
    ...
    def configure_mcp_integration(self) -> "StrandsAgentDIConfiguration":
        ...
        try:
            ...
            self.container.register_singleton(MCPTools, implementation=MCPTools)
        except ImportError:
        ...
        try:
            ...
            self.container.register_singleton(
                MCPAgentSegregationManager, implementation=MCPAgentSegregationManager
            )
        except ImportError:
    ...
    async def initialize_container(self) -> Dict[str, bool]:
        ...
        logger.info(
            f"DI container initialization complete: {success_count}/{total_count} services initialized"
        )
        return results
