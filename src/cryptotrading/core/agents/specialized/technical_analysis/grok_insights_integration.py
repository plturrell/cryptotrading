...
class GrokInsightsClient:
    ...
    async def get_pattern_insights(
        self, pattern_name: str, pattern_data: Dict[str, Any], market_context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
...
async def get_pattern_insights(
    pattern_name: str, pattern_data: Dict[str, Any], market_context: Dict[str, Any] = None
) -> Dict[str, Any]:
    """
    ...
    return await grok_client.get_pattern_insights(pattern_name, pattern_data, market_context)
