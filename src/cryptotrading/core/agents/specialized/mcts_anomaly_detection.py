...
class AnomalyDetector:
    ...
    async def record_metric(self, metric_name: str, value: float, 
        ...
        for anomaly_value, confidence, detection_method in anomalies:
            await self._handle_anomaly(metric_name, anomaly_value, confidence, 
                                     detection_method, context or {})
    ...
    def _classify_anomaly(self, metric_name: str, value: float, 
                         context: Dict[str, Any]) -> Tuple[AnomalyType, AnomalySeverity]:
    ...
    def _generate_alert_message(self, metric_name: str, value: float, 
                               detection_method: str, context: Dict[str, Any]) -> str:
    ...
    def get_active_alerts(self, severity_threshold: AnomalySeverity = AnomalySeverity.LOW) -> List[AnomalyAlert]:
        ...
        return [
            ...
            if (alert.resolved_at is None and 
                severity_order[alert.severity] >= threshold_level)
        ]
