...
class VercelRuntimeAdapter:
    ...
    def __init__(self):
        ...
        logger.info(f"Vercel Runtime Adapter initialized - Vercel: {self.is_vercel}, Edge: {self.is_edge_runtime}")
        ...
        def decorator(func):
            ...
            async def wrapper(*args, **kwargs):
                ...
                async def timeout_monitor():
                    ...
                    raise VercelTimeoutError(f"Operation approaching Vercel timeout limit ({timeout}s)")
    ...
    async def safe_cache_operation(self, operation: str, key: str, 
                                  value: Any = None, ttl: int = 300) -> Any:
        ...
        try:
            ...
            result = await vercel_adapter.timeout_handler()(
                vercel_adapter.memory_guard()(
                    vercel_adapter.edge_compatible(func)
                )
            )(*args, **kwargs)
