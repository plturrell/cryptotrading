...
class LifecycleManager:
    ...
    def register_component(self, component_id: str, component_type: ComponentType,
                          component_ref: Any, dependencies: List[str] = None) -> ComponentHealth:
    ...
    def unregister_component(self, component_id: str):
        ...
        if component_id in self.components:
            self._record_event(component_id, "unregistered", 
                             self.components[component_id].state, LifecycleState.STOPPED)
    ...
    def _record_event(self, component_id: str, event_type: str, 
                     from_state: Optional[LifecycleState], to_state: LifecycleState,
...
@asynccontextmanager
async def managed_component(component_id: str, component_type: ComponentType, 
                           component: Any, dependencies: List[str] = None):
