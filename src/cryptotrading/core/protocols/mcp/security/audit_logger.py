...
class SecurityAuditLogger:
    ...
    def _determine_severity(
        self, event_type: SecurityEventType, threat_detected: bool = False
    ) -> SecuritySeverity:
    ...
    def log_authorization_denied(
        self, security_context: SecurityContext, required_permissions: List[str]
    ):
    ...
    def log_security_threat(
        self, security_context: SecurityContext, threat_type: str, details: str
    ):
    ...
    def log_input_validation_failure(
        self, security_context: SecurityContext, validation_errors: List[str]
    ):
...
def extract_security_context_from_headers(
    headers: Dict[str, str], method: str = None, user_id: str = None
) -> SecurityContext:
