...
class FileResource(Resource):
    ...
    def __init__(
        self, file_path: str, uri: str, name: str, description: str, mime_type: str = "text/plain"
    ):
        ...
        def get_strategy_performance():
            return {
                ...
                "aggregate_performance": {
                    "total_return": 0.12,
                    "sharpe_ratio": 1.6,
                    "correlation_matrix": {"momentum_mean_reversion": 0.15},
                },
            }
            ...
            logs = {
                "trading": [
                    {
                        "timestamp": "2024-01-01T12:00:00Z",
                        "level": "INFO",
                        "message": "BTC buy order filled at $32000",
                    },
                    {
                        "timestamp": "2024-01-01T11:58:00Z",
                        "level": "INFO",
                        "message": "ETH sell signal generated",
                    },
                    {
                ...
                "system": [
                    ...
                    },
                    {
                        ...
                        "level": "ERROR",
                        "message": "Temporary connection loss to Kraken",
                    },
                    {
                        "timestamp": "2024-01-01T11:58:00Z",
                        "level": "INFO",
                        "message": "Reconnected to all exchanges",
                    },
                ],
            }
