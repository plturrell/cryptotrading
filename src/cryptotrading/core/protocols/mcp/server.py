...
from .protocol import MCPErrorCode, MCPProtocol, MCPRequest, MCPResponse
...
class MCPServer:
    ...
    def _register_standard_methods(self):
        ...
        self.protocol.register_handler(
            "sampling/createMessage", self._handle_sampling_create_message
        )
            ...
            if isinstance(parsed, MCPRequest):
                ...
                try:
                    (
                        processed_params,
                        security_context,
                    ) = await self.security_middleware.process_request(
                        parsed.method, parsed.params or {}, headers or {}
                    )
                ...
                if response:
                    ...
                    if "security_context" in locals() and hasattr(
                        security_context, "response_headers"
                    ):
                        if hasattr(response, "headers"):
    ...
    async def _handle_initialize(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if protocol_version != self.protocol.version:
            logger.warning(
                f"Protocol version mismatch: client={protocol_version}, server={self.protocol.version}"
            )
        ...
        return self.protocol.create_initialize_response(server_info, self.capabilities.to_dict())
    ...
    async def _handle_call_tool(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"content": tool_result.content, "isError": tool_result.isError}
    ...
    async def _handle_read_resource(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "contents": [{"uri": resource.uri, "mimeType": resource.mime_type, "text": content}]
            }
    ...
    async def handle_request(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        mcp_request = MCPRequest(
            method=request.get("method"), params=request.get("params"), id=request.get("id")
        )
