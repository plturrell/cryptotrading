...
class MetricsCollector:
    ...
    def get_metrics(self, since: Optional[float] = None) -> List[Dict[str, Any]]:
        ...
        return [m.to_dict() for m in self.metrics if m.timestamp >= since]
...
class MCPMetrics:
    ...
    def tool_execution_end(
        self, tool_name: str, start_time: float, success: bool = True, user_id: str = None
    ):
