...
from ..factors import ALL_FACTORS, Factor, FactorCategory, get_factor_by_name
...
class FactorQualityValidator:
    ...
    def _initialize_validation_rules(self) -> Dict[str, Dict[str, Any]]:
        ...
        rules.update(
            {
                ...
                "log_return_1h": {"min_value": -2.0, "max_value": 2.0, "outlier_threshold": 3.0},
                "vwap_1h": {
                    "min_value": 0.0,
                ...
                "twap_1h": {"min_value": 0.0, "min_data_points": 60},
                "price_vs_ma_50": {"min_value": 0.5, "max_value": 2.0, "min_data_points": 45},
                "price_vs_ma_200": {"min_value": 0.2, "max_value": 5.0, "min_data_points": 180},
            }
        )
        ...
        rules.update(
            {
                "spot_volume": {"min_value": 0.0, "max_spike_ratio": 100.0, "min_exchanges": 2},
                "volume_24h": {"min_value": 0.0, "min_data_completeness": 0.9},
                "volume_ratio_1h_24h": {
                    "min_value": 0.0,
                    "max_value": 50.0,
                    "min_24h_volume": 10000.0,
                },
                "buy_sell_ratio": {"min_value": 0.1, "max_value": 10.0, "min_trades": 50},
                "large_trade_volume": {
                    "min_value": 0.0,
                    "large_trade_threshold": 100000.0,
                    "min_sample_trades": 1000,
                },
                "volume_momentum": {"min_value": -10.0, "max_value": 10.0, "min_periods": 20},
                "obv": {"allow_negative": True, "min_periods": 100},
                "volume_profile": {
                    "price_bins": 100,
        ...
        rules.update(
            {
                ...
                "macd_signal": {"min_periods": 35, "outlier_threshold": 3.0},
                "bollinger_position": {"min_value": -0.5, "max_value": 1.5, "min_periods": 20},
                "stochastic_k": {"min_value": 0.0, "max_value": 100.0, "min_periods": 14},
                "williams_r": {"min_value": -100.0, "max_value": 0.0, "min_periods": 14},
                "adx": {"min_value": 0.0, "max_value": 100.0, "min_periods": 28},
                "cci": {"min_periods": 20, "outlier_threshold": 4.0},  # CCI can have extreme values
                "mfi": {
                    "min_value": 0.0,
                    "max_value": 100.0,
                    "min_periods": 14,
                ...
                "ichimoku_cloud": {"min_periods": 52},
                "parabolic_sar": {"min_periods": 50},
            }
        )
        ...
        rules.update(
            {
                "volatility_1h": {"min_value": 0.0, "max_value": 10.0, "min_returns": 30},
                "volatility_24h": {"min_value": 0.0, "max_value": 5.0, "min_returns": 200},
                "garch_volatility": {"min_value": 0.0, "max_value": 5.0, "min_periods": 500},
                "volatility_ratio": {
                    "min_value": 0.1,
                    "max_value": 10.0,
                    "min_long_term_vol": 0.01,
                },
                "parkinson_volatility": {"min_value": 0.0, "max_value": 5.0, "min_periods": 50},
                "atr": {"min_value": 0.0, "min_periods": 14},
                "volatility_skew": {"min_value": -3.0, "max_value": 3.0, "min_returns": 100},
            }
        )
        ...
        rules.update(
            {
                ...
                "exchange_flow": {"min_exchanges": 2, "min_volume_usd": 10000.0},
                "liquidation_levels": {
        ...
        rules.update(
            {
                ...
                "active_addresses": {"min_value": 0, "min_addresses": 1000},
                "transaction_volume": {"min_value": 0.0, "min_transactions": 100},
                "exchange_balance": {"min_value": 0.0, "tracked_exchanges": 10},
                "nvt_ratio": {"min_value": 0.0, "max_value": 1000.0, "min_tx_volume": 1000000.0},
                "whale_movements": {"whale_threshold_usd": 1000000.0, "confirmation_blocks": 1},
            }
        )
        ...
        rules.update(
            {
                ...
                "social_sentiment": {"min_value": -1.0, "max_value": 1.0, "min_scored_posts": 50},
                "fear_greed_index": {
                    "min_value": 0,
                    "max_value": 100,
        ...
        rules.update(
            {
                ...
                "gold_correlation": {"min_value": -1.0, "max_value": 1.0, "min_observations": 20},
                "spy_correlation": {"min_value": -1.0, "max_value": 1.0, "min_observations": 20},
            }
        )
        ...
        rules.update(
            {
                ...
                "defi_dominance": {"min_value": 0.0, "max_value": 1.0, "tracked_protocols": 100},
            }
        )
    ...
    def validate_factor(
        ...
        try:
            ...
            if completeness_result["score"] < 0.9:
                failed_rules.append(
                    f"Data completeness too low: {completeness_result['score']:.2f}"
                )
    ...
    def _validate_value_ranges(
        self, factor_name: str, values: pd.Series, rules: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        return {"score": score, "failed_rules": failed_rules, "warnings": warnings}

    def _detect_statistical_outliers(
        self, values: pd.Series, rules: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _validate_time_series_consistency(
        self, values: pd.Series, factor: Factor
    ) -> Dict[str, Any]:
        ...
        if len(values) < 5:
            return {
                "score": 0.5,
                "failed_rules": [],
                "warnings": ["Insufficient data for consistency check"],
            }
    ...
    def _validate_onchain_factor(
        self, factor_name: str, values: pd.Series, symbol: str, rules: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _validate_cross_factor_consistency(
        self, factor_name: str, values: pd.Series, additional_data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def validate_factor_batch(
        self, factor_data: Dict[str, pd.Series], symbol: str, source: DataSourceEnum
    ...
    def _validate_factor_batch_consistency(
        self, factor_data: Dict[str, pd.Series], results: Dict[str, ValidationResult]
    ):
