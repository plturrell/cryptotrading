...
ai_analysis_v2_model = ai_v2_ns.model(
    "AIAnalysisV2",
    {
    ...
    @ai_v2_ns.expect(
        ai_v2_ns.model(
            "AnalysisRequestV2",
            {
                ...
                "include_confidence": fields.Boolean(
                    description="Include confidence scoring", default=True
                ),
            },
        )
    )
    ...
    def get(self, symbol):
        ...
        try:
            ...
            enhanced_news = {
                ...
                "news": news,
                "api_version": "2.0",
                "filters_applied": {"limit": limit, "sentiment_filter": sentiment_filter},
    ...
    @ai_v2_ns.expect(
        ai_v2_ns.model(
            "UserProfileV2",
            {
                ...
                "preferred_assets": fields.List(
                    fields.String, description="Preferred cryptocurrencies"
                ),
            },
        )
    )
...
class AISentimentBatch(Resource):
    ...
    @ai_v2_ns.expect(
        ai_v2_ns.model(
            ...
            {
                "news_items": fields.List(
                    fields.Raw, required=True, description="News articles to analyze"
                ),
                "include_confidence": fields.Boolean(
                    description="Include confidence scores", default=True
                ),
                "granular_analysis": fields.Boolean(
                    description="Include granular sentiment breakdown", default=False
                ),
            },
        )
    )
    ...
    def get(self, symbol):
        ...
        try:
            ...
            insights = {
                ...
                "risk_factors": ["Market volatility", "Macroeconomic uncertainty"],
                "api_version": "2.0",
