...
from ...core.config.environment import get_data_source_config, get_feature_flags, is_vercel
...
class MockDataProvider(DataProvider):
    ...
    async def get_historical_data(self, symbol: str, period: str = "1y") -> Dict[str, Any]:
        ...
        return {"symbol": symbol, "period": period, "data": historical_data, "source": "mock"}
    ...
    async def get_real_time_price(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            data = await asyncio.get_event_loop().run_in_executor(
                None, self.yahoo_client.get_current_price, symbol
            )
        ...
        try:
            ...
            if historical["data"]:
                ...
                technical_indicators = {
                    ...
                    if volumes
                    else price_data["volume_24h"],
                    "price_change_20d": ((closes[-1] - closes[0]) / closes[0] * 100)
                    if len(closes) > 1
                    else 0,
                }
            else:
