...
class CodeQualityMCPAgent:
    ...
    def __init__(self, agent_id: str = "code_quality_agent", config: Optional[Dict[str, Any]] = None):
    ...
    async def process_message(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if tool_name in ["analyze_code_quality", "calculate_complexity_metrics", 
                           "detect_code_smells", "analyze_dependencies", 
                           "calculate_impact_analysis", "generate_quality_report"]:
