        ...
        return [
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "analysis_type": {"type": "string", "enum": ["full", "quick", "security"], "default": "full"},
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "metrics": {"type": "array", "items": {"type": "string"}, "default": ["cyclomatic", "halstead", "maintainability"]}
                    },
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "smell_types": {"type": "array", "items": {"type": "string"}, "description": "Types of smells to detect"},
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "dependency_types": {"type": "array", "items": {"type": "string"}, "default": ["imports", "calls", "inheritance"]},
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "project_path": {"type": "string", "description": "Path to project root"},
                        "report_format": {"type": "string", "enum": ["json", "html", "markdown"], "default": "json"},
