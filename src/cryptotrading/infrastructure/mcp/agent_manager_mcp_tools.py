...
class AgentManagerMCPTools:
    ...
    async def _get_agent_status(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "agent_status": status_data}

        except Exception as e:
            return {"success": False, "error": f"Failed to get agent status: {str(e)}"}
    ...
    async def _list_registered_agents(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for agent in agents:
                ...
                agent_summary["by_type"][agent_type] = (
                    agent_summary["by_type"].get(agent_type, 0) + 1
                )
    ...
    async def _assess_agent_compliance(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "compliance_assessment": assessment_result}

        except Exception as e:
            return {"success": False, "error": f"Failed to assess compliance: {str(e)}"}
    ...
    async def _create_skill_card(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to create skill card: {str(e)}"}
    ...
    async def _get_skill_cards(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "skill_cards": cards_data, "total_cards": len(cards_data)}

        except Exception as e:
            return {"success": False, "error": f"Failed to get skill cards: {str(e)}"}
    ...
    async def _enforce_mcp_segregation(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.agent_manager.enforce_mcp_segregation(
                agent_id, segregation_level, resource_limits
            )
            ...
            return {"success": False, "error": f"Failed to enforce MCP segregation: {str(e)}"}
    ...
    async def _get_system_health(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "system_health": health_data}
