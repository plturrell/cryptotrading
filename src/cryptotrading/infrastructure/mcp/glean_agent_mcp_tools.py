...
class GleanAgentMCPTools:
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "insight_types": {
                            ...
                            "items": {
                                "type": "string",
                                "enum": ["complexity", "coupling", "cohesion", "patterns", "smells", "suggestions"]
                            },
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "languages": {
                            ...
                            "items": {
                                "type": "string",
                                "enum": ["python", "typescript", "javascript", "xml", "json", "yaml"]
                            },
    ...
    def _build_dependency_tree(self, dependencies: List[Dict], depth: int, include_transitive: bool) -> Dict[str, Any]:
    ...
    async def _navigate_code_structure(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to navigate code structure: {str(e)}"
            }
    ...
    async def _get_code_insights(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to get code insights: {str(e)}"
            }
    ...
    async def _validate_code_coverage(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if EXISTING_GLEAN_TOOLS and self.zero_blindspots_tool:
                ...
                validation_args = {
                    "project_path": args.get("target_directories", ["."])[0] if args.get("target_directories") else ".",
                    "languages": args.get("languages", ["python", "typescript"]),
                    "threshold": args.get("validation_threshold", 0.95)
                }
                
                result = await self.zero_blindspots_tool.handle_tool_call("validate_zero_blindspots", validation_args)
                return result
            else:
            ...
            return {
                "success": False,
                "error": f"Failed to validate code coverage: {str(e)}"
            }
    ...
    async def _monitor_code_changes(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if EXISTING_GLEAN_TOOLS and self.continuous_monitor:
                ...
                result = await self.continuous_monitor.handle_tool_call("start_monitoring", monitor_args)
                return result
            else:
    ...
    async def _run_zero_blindspots_validation(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if EXISTING_GLEAN_TOOLS and self.zero_blindspots_tool:
                return await self.zero_blindspots_tool.handle_tool_call("validate_zero_blindspots", args)
            else:
                return {
                    "success": False,
                    "error": "Zero blindspots validation tool not available"
                }
        except Exception as e:
            return {
                "success": False,
                "error": f"Failed to run validation: {str(e)}"
            }
