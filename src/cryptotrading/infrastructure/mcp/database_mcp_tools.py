...
class DatabaseMCPTools:
        ...
        return [
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "raw_response": {"type": "string", "description": "Raw AI model response"},
                    },
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "price": {"type": "number", "description": "Price at signal generation"},
                        "source": {
                            "type": "string",
            ...
            },
            {
                ...
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "strategy_name": {"type": "string", "description": "Strategy name filter"},
                        ...
                        "min_return": {"type": "number", "description": "Minimum return filter"},
                        "limit": {
                            "type": "integer",
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "final_capital": {"type": "number", "description": "Final capital amount"},
                        "total_return": {
                            "type": "number",
                        ...
                        "results": {"type": "object", "description": "Detailed results data"},
                    },
                    "required": [
                        "strategy_name",
                        "symbol",
    ...
    async def _query_market_data(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to query market data: {str(e)}"}
    ...
    async def _store_ai_analysis(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to store AI analysis: {str(e)}"}
    ...
    async def _get_portfolio_data(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to get portfolio data: {str(e)}"}
    ...
    async def _store_trading_signal(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to store trading signal: {str(e)}"}
    ...
    async def _get_backtest_results(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to get backtest results: {str(e)}"}
    ...
    async def _store_backtest_result(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to store backtest result: {str(e)}"}
            ...
            if args.get("include_table_stats", True):
                ...
                for table in tables:
                    try:
                        ...
                        table_stats[table] = {"record_count": 0, "status": f"error: {str(e)}"}
    ...
    async def _purge_expired_data(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Failed to cleanup old data: {str(e)}"}
