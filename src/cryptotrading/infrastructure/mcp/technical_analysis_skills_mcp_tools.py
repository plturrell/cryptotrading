...
from ...core.agents.specialized.technical_analysis.skill_1_momentum_indicators import (
    MomentumIndicatorsSkill,
)
from ...core.agents.specialized.technical_analysis.skill_2_momentum_volatility import (
    MomentumVolatilitySkill,
)
from ...core.agents.specialized.technical_analysis.skill_3_volume_analysis import (
    VolumeAnalysisSkill,
)
from ...core.agents.specialized.technical_analysis.skill_4_support_resistance import (
    SupportResistanceSkill,
)
from ...core.agents.specialized.technical_analysis.skill_6_harmonic_patterns import (
    AdvancedPatternsSkill,
)
from ...core.agents.specialized.technical_analysis.skill_7_comprehensive_system import (
        ...
        return [
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "market_data": {
                            "type": "string",
                            "description": "JSON string containing OHLCV data",
                        },
                        "indicators": {
                            "type": "array",
                            "items": {"type": "string"},
                        ...
                        "periods": {
                            "type": "object",
                            "description": "Period settings for indicators",
                        },
                    },
