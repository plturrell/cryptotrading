...
class MLModelsMCPTools:
        ...
        return [
            {
                ...
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "model_type": {"type": "string", "enum": ["lstm", "transformer", "ensemble"], "description": "Type of model to train"},
                        "training_data": {"type": "string", "description": "JSON string containing training data"},
                        "features": {"type": "array", "items": {"type": "string"}, "description": "Feature columns to use"},
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "input_data": {"type": "string", "description": "JSON string containing input data"},
                        "prediction_horizon": {"type": "integer", "default": 1, "description": "Number of periods to predict"},
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "test_data": {"type": "string", "description": "JSON string containing test data"},
                        "metrics": {"type": "array", "items": {"type": "string"}, "default": ["mse", "mae", "r2"]}
                    },
            ...
            },
            {
                ...
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "model_type": {"type": "string", "enum": ["lstm", "transformer", "ensemble"]},
                        "training_data": {"type": "string", "description": "JSON string containing training data"},
                        "param_grid": {"type": "object", "description": "Parameter grid for optimization"},
                        "optimization_method": {"type": "string", "enum": ["grid", "random", "bayesian"], "default": "grid"}
                    },
            ...
            },
            {
                ...
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "model_ids": {"type": "array", "items": {"type": "string"}, "description": "List of model IDs to ensemble"},
                        "input_data": {"type": "string", "description": "JSON string containing input data"},
                        "ensemble_method": {"type": "string", "enum": ["average", "weighted", "voting"], "default": "average"},
                        "weights": {"type": "array", "items": {"type": "number"}, "description": "Weights for weighted ensemble"}
                    },
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "method": {"type": "string", "enum": ["permutation", "shap", "built_in"], "default": "permutation"}
                    },
                    "required": ["model_id"]
                }
            }
    ...
    async def _handle_train_model(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Train model
            model_result = await self.ml_training.train_model(
    ...
    async def _handle_predict_prices(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "confidence_intervals": predictions.get("confidence_intervals") if confidence_interval else None,
                "model_id": model_id,
