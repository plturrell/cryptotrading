...
class MCTSCalculationMCPAgent(BaseAgent):
    ...
    def __init__(self, agent_id: str = "mcts_calculation_mcp_agent"):
        ...
        logger.info(
            f"MCTS Calculation MCP Agent {agent_id} initialized with {len(self.mcp_tools.tools)} tools"
        )
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            test_result = await self.mcp_tools.handle_tool_call(
                "mcts_get_performance_metrics", {"calculation_id": "test"}
            )
    ...
    async def _handle_metrics_request(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.mcp_tools.handle_tool_call(
                ...
                {"calculation_id": calculation_id, "include_convergence": include_convergence},
            )
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_result = await self.mcp_tools.handle_tool_call("mcts_get_performance_metrics", {})
