...
class TechnicalAnalysisMCPServer:
    ...
    async def _handle_comprehensive_analysis(self, data: pd.DataFrame, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_momentum_indicators(self, data: pd.DataFrame, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            momentum_result = await self.ta_agent.execute_tool("analyze_momentum_indicators", {"data": data})
            ...
            if momentum_result.success:
                ...
                return {
                    "success": False,
                    "error": "Momentum indicators analysis failed"
                }
                
        except Exception as e:
            return {
                "success": False,
                "error": f"Momentum indicators analysis error: {str(e)}"
            }
    ...
    async def _handle_support_resistance(self, data: pd.DataFrame, symbol: str) -> Dict[str, Any]:
        ...
        """
        try:
            sr_result = await self.ta_agent.execute_tool("analyze_support_resistance", {"data": data})
            ...
            return {
                "success": False,
                "error": f"Support/resistance analysis error: {str(e)}"
            }
    ...
    async def _handle_chart_patterns(self, data: pd.DataFrame, symbol: str) -> Dict[str, Any]:
        ...
        """
        try:
            pattern_result = await self.ta_agent.execute_tool("analyze_chart_patterns", {"data": data})
            ...
            if pattern_result.success:
                ...
                return {
                    "success": False,
                    "error": "Chart pattern analysis failed"
                }
                
        except Exception as e:
            return {
                "success": False,
                "error": f"Chart pattern analysis error: {str(e)}"
            }
    
    
    async def _handle_dashboard_creation(self, data: pd.DataFrame, arguments: Dict[str, Any]) -> Dict[str, Any]:
        """
