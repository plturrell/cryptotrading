...
class SecretsManager:
    ...
    def create_secret(
        self, secret_name: str, secret_value: Dict[str, str], description: str = None
    ) -> bool:
        """
...
def setup_crypto_trading_secrets():
    ...
    print(
        f'2. Run: python3 -c "from storage.aws_secrets_manager import setup_crypto_trading_secrets; setup_crypto_trading_secrets()"'
    )
