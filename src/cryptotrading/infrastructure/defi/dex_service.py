...
class DEXService:
    ...
    async def get_trending_pools_aggregated(
        self, networks: List[str] = None, limit_per_network: int = 10
    ) -> DEXTrend:
        ...
        try:
            ...
            network_tasks = [
                self.get_trending_pools(network, limit_per_network) for network in networks
            ]
    ...
    async def get_trending_dict(
        self, networks: List[str] = None, limit_per_network: int = 5
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "summary": {
                    ...
                    or ["eth", "bsc", "polygon_pos", "arbitrum", "base"],
                },
            ...
            return {"error": str(e), "status": "error", "source": "geckoterminal_api"}
