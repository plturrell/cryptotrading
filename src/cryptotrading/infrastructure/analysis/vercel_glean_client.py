...
from .angle_parser import PYTHON_QUERIES, AngleQueryEngine, create_query
...
class VercelGleanClient:
    ...
    async def index_project(
        self, unit_name: str = "default", force_reindex: bool = False
    ) -> Dict[str, Any]:
    ...
    async def analyze_dependencies(self, module: str, max_depth: int = 3) -> Dict[str, Any]:
        ...
        try:
            ...
            dependencies = {"direct": [], "transitive": [], "depth_map": {}}
            ...
            while current_depth < max_depth:
                current_level = [
                    mod
                    for mod, depth in dependencies["depth_map"].items()
        ...
        try:
            ...
            for forbidden in rules.get("forbidden_dependencies", []):
                ...
                for ref in refs:
                    ...
                    if source_pattern in source_file and target_pattern in target_module:
                        violations.append(
                            {
