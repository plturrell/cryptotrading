...
class ArchitectureValidator:
    ...
    def __init__(self, glean_client: GleanClient):
        ...
        self.forbidden_dependencies = {
            ...
            "cryptotrading.infrastructure": [
                "cryptotrading.core.agents",
                "cryptotrading.core.protocols",
            ],
        }
        ...
        # Coupling limits
        self.coupling_limits = {"max_dependencies_per_module": 15, "max_dependents_per_module": 20}
    ...
    def generate_violation_report(self) -> Dict[str, Any]:
        ...
        if critical_count > 0:
            status = "critical"
            message = (
                f"🚨 {critical_count} critical architectural violations require immediate attention!"
            )
        elif high_count > 0:
            status = "warning"
