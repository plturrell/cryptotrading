...
class CLRSMCPTools:
    ...
    async def sort_code_symbols(
        self, symbols: List[Dict[str, Any]], sort_by: str = "usage", algorithm: str = "quicksort"
    ) -> Dict[str, Any]:
    ...
    async def search_code_symbols(
        ...
        try:
            ...
            sorted_symbols = self.sorting.quicksort(
                ...
                else (1 if a.get("name", "") > b.get("name", "") else 0),
            )
            ...
            index = self.search.binary_search(
                symbol_names, target_name, lambda a, b: -1 if a < b else (1 if a > b else 0)
            )
    ...
    async def find_shortest_call_path(
        self, call_graph: Dict[str, List[str]], start_function: str, end_function: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "path_exists": shortest_paths.distances.get(end_function, float("inf"))
                != float("inf"),
            }
...
class TreeMCPTools:
    ...
    async def process_ast_structure(
        self, ast_data: Dict[str, Any], operation: str, **kwargs
    ) -> Dict[str, Any]:
        ...
        try:
            if operation == "flatten":
                ...
                return {
                    ...
                    "operation": "get_paths",
                    "paths": [
                        {"path": path.keys, "value_type": type(path.value).__name__}
                        for path in paths
                    ],
        ...
        try:
            ...
            return {
                ...
                "hierarchy_analysis": {
                    ...
                    "complexity_score": self._calculate_hierarchy_complexity(
                        depth, node_count, leaf_count
                    ),
                },
    ...
    async def compare_code_structures(
    ...
    async def navigate_code_path(
        self, structure: Dict[str, Any], path: List[Union[str, int]], operation: str = "get"
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "merge_analysis": {
                    ...
                    "merge_complexity": self._assess_merge_complexity(
                        base_config, override_config, merged
                    ),
                },
            }
...
class GleanAnalysisMCPTools:
    ...
    async def comprehensive_code_analysis(self, codebase_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            results = {"success": True, "analysis_components": [], "overall_metrics": {}}

            # Extract modules and dependencies for CLRS analysis
            if "modules" in codebase_data:
                dep_analysis = await self.clrs_tools.analyze_dependency_graph(
                    codebase_data["modules"]
                )
            ...
            if "file_structure" in codebase_data:
                hierarchy_analysis = await self.tree_tools.analyze_code_hierarchy(
                    codebase_data["file_structure"]
                )
            ...
            if "code_samples" in codebase_data and len(codebase_data["code_samples"]) >= 2:
                ...
                for i in range(len(samples) - 1):
                    similarity = await self.clrs_tools.analyze_code_similarity(
    ...
    async def optimize_code_structure(
        self, current_structure: Dict[str, Any], optimization_goals: List[str]
    ) -> Dict[str, Any]:
    ...
    def _calculate_overall_metrics(self, analysis_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        metrics = {"complexity_score": 0.0, "modularity_score": 0.0, "maintainability_score": 0.0}
        ...
        metrics["maintainability_score"] = (1.0 - metrics["complexity_score"]) * 0.4 + metrics[
            "modularity_score"
        ] * 0.6
    ...
    def _generate_complexity_optimizations(
        self, hierarchy_analysis: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _generate_performance_optimizations(self, structure: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if isinstance(structure, dict):
            ...
            if total_keys > 10000:
                recommendations.append(
                    "Large structure detected - consider lazy loading or pagination"
                )

        return {"structure_size": len(str(structure)), "recommendations": recommendations}
