...
class AngleParser:
    ...
    def parse(self, query: str) -> AngleQuery:
        ...
        return AngleQuery(predicate=predicate, patterns=patterns, recursive=recursive)
...
class AngleQueryEngine:
    ...
    def _matches_with_bindings(
        self, query: AngleQuery, fact: Dict[str, Any], bindings: Dict[str, List[Any]]
    ) -> bool:
