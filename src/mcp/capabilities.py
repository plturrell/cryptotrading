...
class CapabilityNegotiator:
    ...
    def negotiate(self, client_caps: Dict[str, Any], server_caps: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "tools" in server_caps and "tools" in client_caps:
            negotiated["tools"] = self._negotiate_tools(
                client_caps["tools"], 
                server_caps["tools"]
            )
        ...
        if "resources" in server_caps and "resources" in client_caps:
            negotiated["resources"] = self._negotiate_resources(
                client_caps["resources"], 
                server_caps["resources"]
            )
    ...
    def _negotiate_tools(self, client_tools: Dict[str, Any], server_tools: Dict[str, Any]) -> Dict[str, Any]:
        """Negotiate tools capabilities"""
        return {
            "listChanged": server_tools.get("listChanged", False)
        }
    
    def _negotiate_resources(self, client_resources: Dict[str, Any], server_resources: Dict[str, Any]) -> Dict[str, Any]:
