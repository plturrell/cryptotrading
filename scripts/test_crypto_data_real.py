...
def test_comprehensive_crypto_data():
    ...
    try:
        ...
        with patch('src.cryptotrading.infrastructure.storage.s3_storage_service.SecretsManager', return_value=mock_secrets_manager):
    ...
    reports = {
        'technical_analysis': {
            ...
            'indicators': {
                ...
                'bollinger_bands': {
                    'BTC-USD': {'upper': 67000, 'middle': 65000, 'lower': 63000}
                }
            },
            'signals': {
