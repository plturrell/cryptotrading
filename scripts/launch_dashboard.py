...
async def launch_dashboard(host: str = "localhost", port: int = 8090, 
                    ...
                    if response.status == 200:
                        ...
                        if not result.get("isError", False):
                            ...
                            if content.get("type") == "resource":
                                ...
                                print(f"Real-time Monitoring: {'✅ Active' if status_data.get('realtime_status') == 'active' else '❌ Inactive'}")
...
async def main():
    ...
    parser.add_argument("--mcp-url", default="http://localhost:8082", help="MCP server URL (default: http://localhost:8082)")
