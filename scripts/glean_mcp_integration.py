...
class GleanMCPIntegration:
    ...
    async def run_comprehensive_analysis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            results["mcp_status"] = {"available_tools": len(mcp_tools), "tools": mcp_tools}
    ...
    async def _test_mcp_tool_registration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": len(tools) > 0, "tools_registered": len(tools)}
        except Exception as e:
            return {"success": False, "error": str(e)}
    ...
    async def _test_mcp_tool_execution(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "dependencies_found": deps.get("total_dependencies", 0)}
        except Exception as e:
            return {"success": False, "error": str(e)}
    ...
    def _generate_integration_report(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "summary": {
                "files_analyzed": glean.get("indexing", {})
                .get("stats", {})
                .get("files_indexed", 0),
    ...
    def _generate_recommendations(self, results: Dict[str, Any]) -> List[str]:
        ...
        if violations > 0:
            recommendations.append(
                f"Fix {violations} architecture violations to improve code quality"
            )
