 ...
 */
entity FactorDefinitions : managed {
    key id          : Integer @title: 'ID';
    name            : String(100) @title: 'Name' not null;
    category        : String(50) @title: 'Category' not null;
    description     : String(500) @title: 'Description';
    lookbackHours   : Decimal(10,2) @title: 'Lookback Hours';
    updateFrequencyMinutes : Integer @title: 'Update Frequency (minutes)' default 15;
    minValue        : Decimal(20,4) @title: 'Min Value';
    maxValue        : Decimal(20,4) @title: 'Max Value';
    formula         : LargeString @title: 'Formula';
    dependencies    : LargeString @title: 'Dependencies';
