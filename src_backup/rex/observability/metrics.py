...
class BusinessMetrics:
    ...
    def track_trade_execution(self, symbol: str, side: str, quantity: float, 
    ...
    def track_agent_operation(self, agent_id: str, operation: str, 
    ...
    def track_data_processing(self, source: str, symbol: str, records_processed: int,
                            success: bool, duration_ms: float):
    ...
    def track_ai_operation(self, operation: str, model: str, symbol: str, 
                          success: bool, duration_ms: float):
