sap.ui.define([
    ...
    return Controller.extend("com.rex.cryptotrading.controller.App", {
        ...
        onInit: function () {
            // Set tile model with proper error handling
            ...
            if (!oModel) {
                console.error("App model not found - waiting for component initialization");
                return;
            }
            
            var aTiles = oModel.getProperty("/tiles");
            if (!aTiles) {
                console.error("Tiles property not found in app model");
                return;
            }
