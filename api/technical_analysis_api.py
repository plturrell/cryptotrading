...
from src.cryptotrading.core.agents.specialized.technical_analysis.technical_analysis_agent import (
...
async def get_comprehensive_analysis(request: TechnicalAnalysisRequest):
    ...
    try:
        ...
        response_data = _process_analysis_result(analysis_result, request, market_data)
...
async def get_indicators(symbol: str, timeframe: str = "1d"):
    ...
    try:
        ...
        from src.cryptotrading.core.agents.specialized.technical_analysis.skill_1_basic_indicators import (
            calculate_sma,
            calculate_ema,
            calculate_rsi,
        )
...
async def get_patterns(symbol: str, timeframe: str = "1d"):
    ...
    try:
        ...
        from src.cryptotrading.core.agents.specialized.technical_analysis.skill_5_chart_patterns import (
...
def _process_analysis_result(
    analysis_result: Dict[str, Any], request: TechnicalAnalysisRequest, market_data: pd.DataFrame
    ...
    if not ai_insights:
        ai_insights = {
            ...
            "key_signals": [
                ...
                {
                    "signal": "MACD Bullish",
                    "explanation": "MACD crossover suggests upward momentum",
                },
            ],
    ...
    return TechnicalAnalysisResponse(
        ...
        analysis_summary={
            ...
            else ("bullish" if price_change_24h > 0 else "bearish"),
...
def _create_chart_data(
    market_data: pd.DataFrame, indicators: Dict[str, Any]
) -> Dict[str, List[Dict]]:
    ...
    for i, (_, row) in enumerate(market_data.tail(50).iterrows()):
        ...
        rsi_data.append({"date": row["date"].strftime("%Y-%m-%d"), "rsi": round(rsi_value, 1)})
