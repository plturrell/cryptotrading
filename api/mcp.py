...
class VercelMCPServer:
    ...
    async def _add_custom_tools(self):
        ...
        try:
            ...
            from cryptotrading.infrastructure.mcp.technical_analysis_mcp_tools import technical_analysis_mcp_tools
            from cryptotrading.infrastructure.mcp.mcts_calculation_mcp_tools import mcts_calculation_mcp_tools
            from cryptotrading.infrastructure.mcp.historical_data_mcp_tools import historical_data_mcp_tools
            from cryptotrading.infrastructure.mcp.database_mcp_tools import database_mcp_tools
            from cryptotrading.infrastructure.mcp.agent_manager_mcp_tools import agent_manager_mcp_tools
            ...
            from src.cryptotrading.infrastructure.mcp.feature_store_mcp_tools import FeatureStoreMCPTools
            from src.cryptotrading.infrastructure.mcp.data_analysis_mcp_tools import DataAnalysisMCPTools
            from src.cryptotrading.infrastructure.mcp.clrs_algorithms_mcp_tools import CLRSAlgorithmsMCPTools
            ...
            from src.cryptotrading.infrastructure.mcp.mcts_calculation_mcp_tools import MCTSCalculationMCPTools
            # Import CLRS Tree MCP Tools
            from cryptotrading.infrastructure.analysis.clrs_tree_mcp_tools import (
                CLRSMCPTools, TreeMCPTools, GleanAnalysisMCPTools, GLEAN_MCP_TOOLS
            )
            ...
            await self._register_clrs_mcp_tools(clrs_mcp_tools, tree_mcp_tools, enhanced_glean_tools)
            ...
            from src.cryptotrading.core.protocols.a2a.agent_registry_integration import initialize_mcp_a2a_integration, start_mcp_agents
            ...
            for agent_name, tool_instance in agent_tools:
                if hasattr(tool_instance, 'tools') and hasattr(tool_instance, 'handle_tool_call'):
                    for tool_def in tool_instance.tools:
                        ...
                        async def tool_wrapper(*args, tool_instance=tool_instance, tool_name=tool_def['name'], **kwargs):
    ...
    async def _register_clrs_mcp_tools(self, clrs_tools, tree_tools, enhanced_tools):
        ...
        self.server.add_tool(
            ...
            input_schema={
                "type": "object",
                "properties": {
                    "codebase": {"type": "object", "description": "Codebase structure"}
                },
                "required": ["codebase"]
            }
        )
        ...
        self.server.add_tool(
            ...
            input_schema={
                "type": "object",
                "properties": {
                    "current_structure": {"type": "object", "description": "Current code structure"},
                    "optimization_goals": {
                        "type": "array",
                        "items": {"type": "string"},
    ...
    async def _initialize_agent_lifecycle_manager(self):
        ...
        try:
            from cryptotrading.core.agents.mcp_agent_lifecycle_manager import get_mcp_agent_lifecycle_manager
    ...
    async def _add_lifecycle_management_tools(self):
        ...
        self.server.add_tool(
            ...
            handler=start_agent,
            input_schema={"agent_id": {"type": "string", "description": "ID of the agent to start"}}
        )
        ...
        self.server.add_tool(
            ...
            input_schema={"agent_id": {"type": "string", "description": "ID of the agent to restart"}}
        )
        ...
        self.server.add_tool(
            ...
            input_schema={"agent_id": {"type": "string", "description": "ID of the agent to check"}}
        )
