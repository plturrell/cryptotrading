    ...
    try:
        ...
        try:
            ...
            if "volume_ratio_20" in valid_features:
                ...
                feature_values["volume_ratio_20"] = (
...
if __name__ == "__main__":
    ...
    class MockRequest:
        def __init__(self):
            self.args = {"symbol": "BTC", "features": "rsi_14,macd_signal,volatility_20"}
