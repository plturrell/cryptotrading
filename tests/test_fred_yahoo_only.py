"""
Test for FRED and Yahoo Finance integration only
Clean test file with only approved data sources
"""
...
async def test_individual_clients():
    """Test FRED and Yahoo Finance clients individually"""
    print("=" * 60)
...
async def test_a2a_comprehensive_loader():
    ...
    custom_request = DataLoadRequest(
        sources=["yahoo", "fred"],  # Only approved sources
        symbols=["BTC", "ETH"],
...
async def main():
    """Run all tests"""
    print("FRED AND YAHOO FINANCE DATA INTEGRATION TEST")
    print("=" * 60)
